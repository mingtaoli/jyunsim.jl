...
function PropsSI(output::AbstractString, name1::AbstractString, value1::Real, name2::AbstractString, value2::Real, fluid::AbstractString)
    val = ccall( (:PropsSI, coolproplibrary), Cdouble, (Cstring, Cstring, Cdouble, Cstring, Cdouble, Cstring), output, name1, value1, name2, value2, fluid)
    if val == Inf
        error("CoolProp: ", get_global_param_string("errstring"))
    end
    return val
...
function PhaseSI(name1::AbstractString, value1::Real, name2::AbstractString, value2::Real, fluid::AbstractString)
    val = ccall( (:PhaseSI, coolproplibrary), Int32, (Cstring, Cdouble, Cstring, Cdouble, Cstring, Ptr{UInt8}, Int), name1, value1, name2, value2, fluid, message_buffer::Array{UInt8, 1}, buffer_length)
...
function set_departure_functions(string_data::AbstractString)
  errcode = ref{Clong}(0);
  ccall( (:set_departure_functions, coolproplibrary), Nothing, (Cstring, Ptr{Clong}, Ptr{UInt8}, Int), string_data, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
  if errcode != 0
...
function set_reference_state(fluid::AbstractString, reference_state::AbstractString)
    val = ccall( (:set_reference_stateS, coolproplibrary), Cint, (Cstring, Cstring), fluid, reference_state)
    if val == 0
        error("CoolProp: ", get_global_param_string("errstring"))
    end
    return val
...
function set_reference_state(fluid::AbstractString, T::Real, rhomolar::Real, hmolar0::Real, smolar0::Real)
    val = ccall( (:set_reference_stateD, coolproplibrary), Cint, (Cstring, Cdouble, Cdouble, Cdouble, Cdouble), fluid, T, rhomolar, hmolar0, smolar0)
    if val == 0
        error("CoolProp: ", get_global_param_string("errstring"))
    end
    return val
...
function saturation_ancillary(fluid_name::AbstractString, output::AbstractString, quality::Integer, input::AbstractString, value::Real)
    val = ccall( (:saturation_ancillary, coolproplibrary), Cdouble, (Cstring, Cstring, Cint, Cstring, Cdouble), fluid_name, output, quality, input, value)
    if val == Inf
        error("CoolProp: ", get_global_param_string("errstring"))
    end
    return val
...
function set_config(key::AbstractString, val::AbstractString)
    ccall( (:set_config_string, coolproplibrary), Nothing, (Cstring, Cstring), key, val)
...
function set_config(key::AbstractString, val::Real)
    ccall( (:set_config_double, coolproplibrary), Nothing, (Cstring, Cdouble), key, val)
    return get_global_param_string("errstring")
end
...
function set_config(key::AbstractString, val::Bool)
    ccall( (:set_config_bool, coolproplibrary), Nothing, (Cstring, UInt8), key, val)
    return get_global_param_string("errstring")
end
...
function get_global_param_string(key::AbstractString)
    val = ccall( (:get_global_param_string, coolproplibrary), Clong, (Cstring, Ptr{UInt8}, Int), key, message_buffer::Array{UInt8, 1}, buffer_length)
    if val == 0
        error("CoolProp: ", get_global_param_string("errstring"))
    end
...
function get_parameter_information_string(key::AbstractString, outtype::AbstractString)
    ...
    val = ccall( (:get_parameter_information_string, coolproplibrary), Clong, (Cstring, Ptr{UInt8}, Int), key, message_buffer::Array{UInt8, 1}, buffer_length)
    if val == 0
        error("CoolProp: ", get_global_param_string("errstring"))
    end
    return unsafe_string(convert(Ptr{UInt8}, pointer(message_buffer::Array{UInt8, 1})))
...
function get_fluid_param_string(fluid::AbstractString, param::AbstractString)
    val = ccall( (:get_fluid_param_string, coolproplibrary), Clong, (Cstring, Cstring, Ptr{UInt8}, Int), fluid, param, message_buffer::Array{UInt8, 1}, buffer_length)
    if val == 0
        error("CoolProp: ", get_global_param_string("errstring"))
    end
    return unsafe_string(convert(Ptr{UInt8}, pointer(message_buffer::Array{UInt8, 1})))
...
function F2K(tf::Real)
    return ccall( (:F2K, coolproplibrary), Cdouble, (Cdouble,), tf)
end
...
function K2F(tk::Real)
    return ccall( (:K2F, coolproplibrary), Cdouble, (Cdouble,), tk)
end
...
function get_param_index(param::AbstractString)
    val = ccall( (:get_param_index, coolproplibrary), Clong, (Cstring,), param)
    if val == -1
...
function get_input_pair_index(pair::AbstractString)
    val = ccall( (:get_input_pair_index, coolproplibrary), Clong, (Cstring,), pair)
    if val == -1
...
function get_debug_level()
    ccall( (:get_debug_level, coolproplibrary), Cint, () )
end
...
function set_debug_level(level::Integer) # change ::Int to ::Integer to make set_debug_level(get_debug_level()) works on different machine
    ccall( (:set_debug_level, coolproplibrary), Nothing, (Cint,), level)
end
...
function HAPropsSI(output::AbstractString, name1::AbstractString, value1::Real, name2::AbstractString, value2::Real, name3::AbstractString, value3::Real)
    val = ccall( (:HAPropsSI, coolproplibrary), Cdouble, (Cstring, Cstring, Cdouble, Cstring, Cdouble, Cstring, Cdouble), output, name1, value1, name2, value2, name3, value3)
    if val == Inf
        error("CoolProp: ", get_global_param_string("errstring"))
    end
    return val
...
function cair_sat(t::Real)
    val = ccall( (:cair_sat, coolproplibrary), Cdouble, (Cdouble, ), t)
    return val;
end
...
function AbstractState_factory(backend::AbstractString, fluids::AbstractString)
    AbstractState = ccall( (:AbstractState_factory, coolproplibrary), Clong, (Cstring, Cstring, Ref{Clong}, Ptr{UInt8}, Clong), backend, fluids, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
...
function AbstractState_free(handle::Clong)
    ccall( (:AbstractState_free, coolproplibrary), Nothing, (Clong, Ref{Clong}, Ptr{UInt8}, Clong), handle, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_set_fractions(handle::Clong, fractions::Array{Float64})
    ccall( (:AbstractState_set_fractions, coolproplibrary), Nothing, (Clong, Ptr{Cdouble}, Clong, Ref{Clong}, Ptr{UInt8}, Clong), handle, fractions, length(fractions), errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_update(handle::Clong, input_pair::Clong, value1::Real, value2::Real)
    ccall( (:AbstractState_update, coolproplibrary), Nothing, (Clong, Clong, Cdouble, Cdouble, Ref{Clong}, Ptr{UInt8}, Clong), handle, input_pair, value1, value2, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_keyed_output(handle::Clong, param::Clong)
    output = ccall( (:AbstractState_keyed_output, coolproplibrary), Cdouble, (Clong, Clong, Ref{Clong}, Ptr{UInt8}, Clong), handle, param, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    if output == -Inf
...
function AbstractState_specify_phase(handle::Clong, phase::AbstractString)
    ccall( (:AbstractState_specify_phase, coolproplibrary), Nothing, (Clong, Cstring, Ref{Clong}, Ptr{UInt8}, Clong), handle, phase, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_unspecify_phase(handle::Clong)
    ccall( (:AbstractState_unspecify_phase, coolproplibrary), Nothing, (Clong, Ref{Clong}, Ptr{UInt8}, Clong), handle, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_update_and_1_out(handle::Clong, input_pair::Clong, value1::Array{Float64}, value2::Array{Float64}, length::Integer, output::Clong, out::Array{Float64})
    ccall( (:AbstractState_update_and_1_out, coolproplibrary), Nothing, (Clong, Clong, Ref{Cdouble}, Ref{Cdouble}, Clong, Clong, Ref{Cdouble}, Ref{Clong}, Ptr{UInt8}, Clong), handle, input_pair, value1, value2, length, output, out, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return out
end
...
function AbstractState_set_binary_interaction_double(handle::Clong, i::Integer, j::Integer, parameter::AbstractString, value::Real)
    ccall( (:AbstractState_set_binary_interaction_double, coolproplibrary), Nothing, (Clong, Clong, Clong, Cstring, Cdouble, Ref{Clong}, Ptr{UInt8}, Clong), handle, i, j, parameter, value, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_set_cubic_alpha_C(handle::Clong, i::Integer, parameter::AbstractString, c1::Real, c2::Real, c3::Real)
    ccall( (:AbstractState_set_cubic_alpha_C, coolproplibrary), Nothing, (Clong, Clong, Cstring, Cdouble, Cdouble, Cdouble, Ref{Clong}, Ptr{UInt8}, Clong), handle, i, parameter, c1, c2, c3, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_set_fluid_parameter_double(handle::Clong, i::Integer, parameter::AbstractString, value::Real)
    ccall( (:AbstractState_set_fluid_parameter_double, coolproplibrary), Nothing, (Clong, Clong, Cstring, Cdouble, Ref{Clong}, Ptr{UInt8}, Clong), handle, i, parameter, value, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_first_saturation_deriv(handle::Clong, of::Clong, wrt::Clong)
    output = ccall( (:AbstractState_first_saturation_deriv, coolproplibrary), Cdouble, (Clong, Clong, Clong, Ref{Clong}, Ptr{UInt8}, Clong), handle, of, wrt, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    if output == -Inf
        error("CoolProp: no correct state has been set with AbstractState_update")
    end
...
function AbstractState_first_partial_deriv(handle::Clong, of::Clong, wrt::Clong, constant::Clong)
    output = ccall( (:AbstractState_first_partial_deriv, coolproplibrary), Cdouble, (Clong, Clong, Clong, Clong, Ref{Clong}, Ptr{UInt8}, Clong), handle, of, wrt, constant, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    if output == -Inf
        error("CoolProp: no correct state has been set with AbstractState_update")
    end
...
function AbstractState_build_phase_envelope(handle::Clong, level::AbstractString)
    ccall( (:AbstractState_build_phase_envelope, coolproplibrary), Nothing, (Clong, Cstring, Ref{Clong}, Ptr{UInt8}, Clong), handle, level, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_get_phase_envelope_data(handle::Clong, length::Integer, T::Array{Float64}, p::Array{Float64}, rhomolar_vap::Array{Float64}, rhomolar_liq::Array{Float64}, x::Array{Float64}, y::Array{Float64})
    ccall( (:AbstractState_get_phase_envelope_data, coolproplibrary), Nothing, (Clong, Clong, Ref{Cdouble}, Ref{Cdouble}, Ref{Cdouble}, Ref{Cdouble}, Ref{Cdouble}, Ref{Cdouble}, Ref{Clong}, Ptr{UInt8}, Clong), handle, length, T, p, rhomolar_vap, rhomolar_liq, x, y, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
...
function AbstractState_build_spinodal(handle::Clong)
    ccall( (:AbstractState_build_spinodal, coolproplibrary), Nothing, (Clong, Ref{Clong}, Ptr{UInt8}, Clong), handle, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return nothing
end
...
function AbstractState_get_spinodal_data(handle::Clong, length::Integer, tau::Array{Float64}, delta::Array{Float64}, m1::Array{Float64})
    ccall( (:AbstractState_get_spinodal_data, coolproplibrary), Nothing, (Clong, Clong, Ref{Cdouble}, Ref{Cdouble}, Ref{Cdouble}, Ref{Clong}, Ptr{UInt8}, Clong), handle, length, tau, delta, m1, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
    return tau, delta, m1;
end
...
function AbstractState_all_critical_points(handle::Clong, length::Integer, T::Array{Float64}, p::Array{Float64}, rhomolar::Array{Float64}, stable::Array{Clong})
    ccall( (:AbstractState_all_critical_points, coolproplibrary), Nothing, (Clong, Clong, Ref{Cdouble}, Ref{Cdouble}, Ref{Cdouble}, Ref{Clong}, Ref{Clong}, Ptr{UInt8}, Clong), handle, length, T, p, rhomolar, stable, errcode, message_buffer::Array{UInt8, 1}, buffer_length)
    raise(errcode, message_buffer)
